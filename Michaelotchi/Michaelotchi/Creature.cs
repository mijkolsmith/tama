...
namespace Michaelotchi
{
	public class Creature
	{
		...
		public float Energy { get; set; } // perfect at 100, increases slowly
		public int creatureCount;

		public Creature(string name, string userName, float hungerValue, float thirstValue, float engagementValue, float lonelinessValue, float energyValue, int creatureCount)
		{
			Name = name;
			UserName = userName;
			Hunger = hungerValue;
